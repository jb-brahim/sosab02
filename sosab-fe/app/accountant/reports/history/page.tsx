    ...
    return (
        <div className="p-4 space-y-4 pb-24">
            <div className="flex items-center gap-2 mb-4">
                <Button variant="ghost" size="icon" onClick={() => router.push('/accountant/reports')}>
                    <ArrowLeft className="w-5 h-5" />
                </Button>
                <div>
                    <h1 className="text-2xl font-bold flex items-center gap-2">
                        <FileText className="w-6 h-6 text-primary" />
                        {t("reports.title") || "Historique des Rapports"}
                    </h1>
                    <p className="text-muted-foreground text-xs">{t("reports.description") || "Gérer et consulter tous les rapports générés"}</p>
                </div>
                <div className="ml-auto">
                    <Button size="sm" onClick={() => router.push('/accountant/reports')}>
                        {t("reports.new_report") || "+ Nouveau"}
                    </Button>
                </div>
            </div>
