    ...
    return (
        <div className="p-4 space-y-6 max-w-6xl mx-auto pb-24">
            <div className="flex items-center gap-2 mb-4">
                <Button variant="ghost" size="icon" onClick={() => router.push('/accountant')}>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
                ...
                <div className="lg:col-span-5">
                    <Card className="border-border/40 shadow-md h-full flex flex-col min-h-[500px]">
                        <CardContent className="p-6 flex-1 flex flex-col space-y-4">
                            <div className="flex items-center justify-between">
                                ...
                                <Button 
                                    variant="link" 
                                    size="sm" 
                                    onClick={() => router.push('/accountant/reports/history')} 
                            ...
                            {loading ? (
                                ...
                                <div className="flex-1 flex flex-col items-center justify-center p-8 text-center text-muted-foreground bg-muted/5 rounded-xl border border-dashed border-border/30">
                                    <FileText className="w-16 h-16 mx-auto mb-4 opacity-25 text-muted-foreground" />
                                    <span className="text-sm font-bold text-foreground/80">Aucun rapport généré récemment</span>
                                    <span className="text-xs opacity-60 mt-1 max-w-[200px]">Vos rapports apparaîtront ici après génération.</span>
                                </div>
                            ) : (
