...
const gerantNavItems = (t: (key: string) => string) => [
    { href: "/gerant", icon: DollarSign, label: "Récap. Salaires" },
    { href: "/gerant/projects", icon: FolderKanban, label: t("nav.projects") === "nav.projects" ? "Chantier" : (t("nav.projects") === "Projets" ? "Chantier" : t("nav.projects")) || "Chantier" },
