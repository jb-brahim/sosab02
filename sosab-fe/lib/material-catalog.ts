...
export const MATERIAL_CATALOG: MaterialClassification[] = [
    ...
    },
    {
        ...
        items: [
            ...
            { name: "Hourdis de 19", unit: "U" },
            { name: "Brique de 8", unit: "U" },
            { name: "Acier de 6", unit: "T" },
            { name: "Acier HA 8", unit: "T" },
            { name: "Acier HA 10", unit: "T" },
            { name: "Acier HA 12", unit: "T" },
            { name: "Acier HA 14", unit: "T" },
            { name: "Acier HA 16", unit: "T" },
            { name: "Acier HA 20", unit: "T" },
